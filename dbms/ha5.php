<html lang="en">
	...
	<div class="column-1">
		...
		$sql1="select username,mobile_no,address from `user` WHERE email='manager5@gmail.com'";
	...
	<tr>
      ...
      <div class="table-display">
		...
		$sql1="select hotel_name,hotel_type,hotel_location from `hotel` WHERE hotel_id='5'";
		$res=mysqli_query($con,$sql1);
		$sql2= "select room_cost,no_of_rooms,room_type from `rooms` WHERE rooms.hotel_id='5'";
	...
	<tr>
        ...
        <div class=column-2> 
             <div class="contact-display">
                  ...
                  <form action="dupe5.php" method="post">
             ...
             <div class="form-display">
                  ...
                  <form action="x5.php" method="post">
                      <div class="form-group">
                     ...
                     <div class="form-group">
                         <input type="submit" class="btn btn-primary" value="Changes">
                     </div>
                  </form>
          </div>
        </div>
