<html lang="en">
	...
	<div class="column-1">
		...
		$sql1="select username,mobile_no,address from `user` WHERE email='manager4@gmail.com'";
	...
	<tr>
      ...
      <div class="table-display">
		...
		$sql1="select hotel_name,hotel_type,hotel_location from `hotel` WHERE hotel_id='4'";
		$res=mysqli_query($con,$sql1);
		$sql2= "select room_cost,no_of_rooms,room_type from `rooms` WHERE rooms.hotel_id='4'";
	...
	<tr>
        ...
        <div class=column-2> 
             <div class="contact-display">
                  ...
                  <form action="dupe4.php" method="post">
             ...
             <div class="form-display">
                  ...
                  <form action="x4.php" method="post">
                      <div class="form-group">
