<html lang="en">
	...
	<tr>
      ...
      <div class="table-display">
		...
		$sql1="select hotel_name,hotel_type,hotel_location from `hotel` WHERE hotel_id='1'";
		$res=mysqli_query($con,$sql1);
		$sql2= "select room_cost,no_of_rooms,room_type from `rooms` WHERE rooms.hotel_id='1'";
	...
	<tr>
        ...
        <div class=column-2> 
             <div class="contact-display">
                  ...
                  <form action="dupe1.php" method="post">
